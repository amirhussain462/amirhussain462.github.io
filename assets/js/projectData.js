...

{
  ...
  adminNotes: [
    "Add ETV travel testing video after rail renewal if available.",
    "Add before/after rail condition comparison if client-safe."
  ]
},
...
"Diagnosed_Leaked_Hydraulic_Pilot-Operated_CounterBalance_Manifold_for_ETV.png",
  ...
  adminNotes: [
    "Add hydraulic pressure testing video if available.",
    "Add manifold internal inspection photos if client-safe.",
  ...
  adminNotes: [
    "Add current collector replacement video if available.",
    "Add busbar contact condition photo if client-safe.",
    "Add before/after collector condition comparison if available."
  ]
},
...

 {
  ...
  adminNotes: [
    "Add motor installation video if available.",
    "Add drive system testing video after repair if available.",
    "Add clutch sprocket inspection photo if available."
  ]
},

{
  ...
  images: [
    ...
    "Kardex-During_Installation_1.png"
  ],

  videos: [],

  adminNotes: [
    "Add Kardex operation video if available.",
    "Add before/after storage area photo if client-safe.",
...

{
  ...
  adminNotes: [
    "Add maintenance activity photos if available.",
    "Add operational demonstration video if client-safe.",
    "Add before/after repair comparison where possible."
  ]
},
];